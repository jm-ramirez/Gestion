...
Public Class ProvinciasCDat
    ...
    Public Sub Insert(ByVal obj As Provincias)
        Try
            Using cnn As MySqlConnection = CreateConnection()
                ...
                Using cmd As New MySqlCommand
                    With cmd
                        ...
                        .CommandText = "INSERT INTO Provincias (Id,Codigo,Nombre,Pais) VALUES (@Id,@Codigo,@Nombre,@Pais)"
                        .Parameters.AddWithValue("@Id", obj.Id)
                        .Parameters.AddWithValue("@Codigo", obj.Codigo)
                        .Parameters.AddWithValue("@Nombre", obj.Nombre)
                        .Parameters.AddWithValue("@Pais", obj.Pais)
                        .ExecuteNonQuery()
                    End With
                End Using
            End Using
        ...
        End Try
    End Sub
    Public Sub Update(ByVal obj As Provincias)
        Try
            Using cnn As MySqlConnection = CreateConnection()
                cnn.Open()
                Using cmd As New MySqlCommand
                    With cmd
                        .Connection = cnn
                        .CommandType = CommandType.Text
                        .CommandText = "UPDATE Provincias SET Codigo = @Codigo,Nombre = @Nombre,Pais = @Pais WHERE Id = @Id"
                        .Parameters.AddWithValue("@Id", obj.Id)
                        .Parameters.AddWithValue("@Codigo", obj.Codigo)
                        .Parameters.AddWithValue("@Nombre", obj.Nombre)
                        .Parameters.AddWithValue("@Pais", obj.Pais)
            ...
            Using cnn As MySqlConnection = CreateConnection()
                ...
                Using cmd As New MySqlCommand
                    With cmd
                        .Connection = cnn
                        .CommandType = CommandType.Text
                        .CommandText = "DELETE FROM Provincias WHERE Id = @Id"
    ...
    Public Function GetAll() As List(Of Provincias)
        ...
        End Try
    End Function
    Private Function Populate(ByVal reader As MySqlDataReader) As Provincias
        Dim obj As New Provincias
        Try
            With obj
