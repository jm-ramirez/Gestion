Public Class CpraCabecera

    Property Id As UInt32
    Property Concepto As Int32
    Property ProveedorId As UInt32
    ...
    Property Cbtefechaingreso As String
    ...
    Property Importenoinscripto As Double
    ...
    Property CodGastoV As String
    Property CodImp As String
