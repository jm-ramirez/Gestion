Public Class CbteCabecera2

    Property Attachment As Boolean
    ...
    Property Documentonro As String
    ...
    Property Tiporesponsable As String
    ...
    Property CondicionesPago As String
    Property PlazosEntrega As String
    Property LugarEntrega As String
    Property MantenimientoOferta As String
    ...
    Property CbteAlicuotas2 As New List(Of Entidades.CbteAlicuota2)
    Property CbteTributos2 As New List(Of Entidades.CbteTributo2)
    
    Property CbteArticulos2 As New List(Of Entidades.CbteArticulo2)
    Property CbteAsociados2 As New List(Of Entidades.CbteAsociado2)
    'Property CbteDetalleFinanciero As New List(Of Entidades.Financiero)
    Property CbteEstadoCuenta As New List(Of Entidades.CbteAsociado2)
    ...
    Public Function SaldoEstadoCuenta() As Double
        ...
        For Each obj As Entidades.CbteAsociado2 In Me.CbteEstadoCuenta
            saldo += obj.Importe
        Next
    ...
    Public ReadOnly Property SaldoAsociado() As Double
        Get
            ...
            For Each obj As Entidades.CbteAsociado2 In Me.CbteAsociados2
                saldo -= obj.Importe
            Next
