Public Class CbteArticulo2
    ...
    ReadOnly Property ImporteDescuento As Double
        Get
            Return Math.Round(Importe * (Descuento / 100), 2)
        End Get
    End Property
    ...
    ReadOnly Property Subtotal As Double
        Get
            If Me.AlicuotaCodigo <> CODIGO_ALIC_EXENTO And Me.AlicuotaCodigo <> CODIGO_ALIC_NOGRAVADO Then
                'Return IIf(UCase(Unidad) = "KG", ImporteFinal, Math.Round(ImporteFinal * Cantidad, 2))
                Return IIf(UCase(Unidad) = "KG", 0, Math.Round(ImporteFinal * Cantidad, 2))
            Else
                Return 0.0
            End If
        End Get
    ...
    ReadOnly Property SubtotalImpuestoInterno As Double
        Get
            Return Math.Round(ImpuestoInterno * Cantidad, 2)
        End Get
    End Property

    ReadOnly Property BaseImponibleImpInterno As Double
        Get
            Return Math.Round((ImporteFinal + ImpuestoInterno) * Cantidad, 2)
        End Get
    End Property
    ...
    ReadOnly Property SubtotalSinIVA As Double
        Get
            ...
            _subtotalSinIVA = Math.Round(ImporteFinal * Cantidad, 2)
    ...
    ReadOnly Property SubtotalConIVA As Double
        Get
            Return Math.Round(ImporteConIVA * Cantidad, 2)
        End Get
    End Property
    ...
    ReadOnly Property SubtotalFinal As Double
        Get
            _subtotalFinal = Math.Round(ImporteConIVA * Cantidad, 2)
    ...
    ReadOnly Property SubtotalIVA As Double
        Get
            Return Math.Round(ImporteIVA * Cantidad, 2, MidpointRounding.ToEven)
        End Get
    End Property
    ...
    ReadOnly Property SubtotalNoGravado As Double
        Get
            If AlicuotaCodigo = CODIGO_ALIC_NOGRAVADO Then
                Return Math.Round(ImporteFinal * Cantidad, 2)
            Else
                Return 0.0
            End If
        End Get
