...
Public Class FormABMZona
    Private _repositorio As New CapaLogica.ZonaCLog
    Private _editForm As New FormZona
    ...
    Private Sub Editar()
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            _editForm.Entidad = DirectCast(Me.FOLVRegistros.SelectedObject, Entidades.Zona)
    ...
    Private Sub Eliminar()
        ...
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            If MessageBox.Show("Desea eliminar el registro seleccionado?", "Eliminar registro", _
                ...
                _repositorio.Delete(DirectCast(FOLVRegistros.SelectedObject, Entidades.Zona).Id)
    ...
    Private Sub Imprimir()
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\lstZonas.rdl"
            r.Nombre = "Listado de Zonas"
            ...
            r.Parametros.Add(New GeneradorReportes.Parametro("cdesde", DirectCast(FOLVRegistros.SelectedObject, Entidades.Zona).Id))
            r.Parametros.Add(New GeneradorReportes.Parametro("chasta", DirectCast(FOLVRegistros.SelectedObject, Entidades.Zona).Id))
    ...
    Private Sub FormABMZona_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
