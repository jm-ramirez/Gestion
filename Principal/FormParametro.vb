Public Class FormParametro
    ...
    'entidad
    Property Entidad As Entidades.Parametro
    ...
    Private Sub InicializarFormulario()
        ...
        If Not Entidad Is Nothing Then
            ...
            Me.TextBoxValor.Text = Entidad.Valorpredeterminado
            Me.CheckBoxActivo.Checked = Entidad.Activo
            Me.ComboBoxTipo.Text = Entidad.Tipo
    ...
    Private Sub FormParametro_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Me.TextBoxNombre.Focus()
    End Sub

    Private Sub FormParametro_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'iniciar formulario
