Public Class FormABMFormaPago
    Private _repositorio As New CapaLogica.FormadepagoCLog
    Private _editForm As New FormFormasdePago
    ...
    Private Sub Editar()
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            _editForm.Entidad = DirectCast(Me.FOLVRegistros.SelectedObject, Entidades.Formadepago)
