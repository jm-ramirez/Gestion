Public Class FormInformeConsumoRubro
    ...
    Private Sub Reporte()
        ...
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\infConsumoRubro.rdl"
    ...
    Private Sub FormInformeConsumoRubro_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        Me.Text = "Informe de Consumo por Rubro"
    End Sub

    Private Sub FormInformeConsumoRubro_Load(sender As Object, e As System.EventArgs) Handles Me.Load
