...
Public Class FormABMCliente

    Private _repositorio As New CapaLogica.ClienteCLog
    Private _editForm As FormCliente
    ...
    Private Sub Editar()
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            _editForm = New FormCliente
            _editForm.Entidad = DirectCast(Me.FOLVRegistros.SelectedObject, Entidades.Cliente)
    ...
    Private Sub Eliminar()
        ...
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            If MessageBox.Show("Desea eliminar el registro seleccionado?", "Eliminar registro", _
                ...
                _repositorio.Delete(DirectCast(FOLVRegistros.SelectedObject, Entidades.Cliente).Id)
    ...
    Private Sub Imprimir()
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\lstClientes.rdl"
            r.Nombre = "Listado de Clientes"
            ...
            r.Parametros.Add(New GeneradorReportes.Parametro("cdesde", DirectCast(FOLVRegistros.SelectedObject, Entidades.Cliente).Codigo))
            r.Parametros.Add(New GeneradorReportes.Parametro("chasta", DirectCast(FOLVRegistros.SelectedObject, Entidades.Cliente).Codigo))
