...
Public Class FormABMConceptobancario
    Private _repositorio As New CapaLogica.ConceptobancarioCLog
    Private _editForm As New FormConceptobancario
    ...
    Private Sub Editar()
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            _editForm.Entidad = DirectCast(Me.FOLVRegistros.SelectedObject, Entidades.Conceptobancario)
    ...
    Private Sub Eliminar()
        ...
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            If DirectCast(FOLVRegistros.SelectedObject, Entidades.Conceptobancario).Codigo = CONCEPTO_CHEQUE_RECIBIDO Or _
                DirectCast(FOLVRegistros.SelectedObject, Entidades.Conceptobancario).Codigo = CONCEPTO_CHEQUE_PASADO Or _
                DirectCast(FOLVRegistros.SelectedObject, Entidades.Conceptobancario).Codigo = CONCEPTO_CHEQUE_DEPOSITADO Or _
                DirectCast(FOLVRegistros.SelectedObject, Entidades.Conceptobancario).Codigo = CONCEPTO_CHEQUE_RECHAZADO Or _
                DirectCast(FOLVRegistros.SelectedObject, Entidades.Conceptobancario).Codigo = repoparametro.GetByNombre("ConceptoAjusteIngreso").Valorpredeterminado Or _
                DirectCast(FOLVRegistros.SelectedObject, Entidades.Conceptobancario).Codigo = repoparametro.GetByNombre("ConceptoAjusteEgreso").Valorpredeterminado Then

                MessageBox.Show("El código se encuentra Reservado", "Eliminar registro", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            ...
            If MessageBox.Show("Desea eliminar el registro seleccionado?", "Eliminar registro", _
                ...
                _repositorio.Delete(DirectCast(FOLVRegistros.SelectedObject, Entidades.Conceptobancario).Id)
    ...
    Private Sub Imprimir()
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\lstconceptobancario.rdl"
            r.Nombre = "Listado de Conceptos Financieros"
            ...
            r.Parametros.Add(New GeneradorReportes.Parametro("cdesde", DirectCast(FOLVRegistros.SelectedObject, Entidades.Conceptobancario).Codigo))
            r.Parametros.Add(New GeneradorReportes.Parametro("chasta", DirectCast(FOLVRegistros.SelectedObject, Entidades.Conceptobancario).Codigo))
    ...
    Private Sub CrearColumnas()
        ...
        With FOLVRegistros
            ...
            c.AspectName = "Plazo"
            c.MinimumWidth = 100
            c.HeaderTextAlign = HorizontalAlignment.Center
    ...
    Private Sub FormABMConceptobancario_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
