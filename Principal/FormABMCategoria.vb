...
Public Class FormABMCategoria
    Private _repositorio As New CapaLogica.CategoriaCLog
    Private _editForm As New FormCategoria
    ...
    Private Sub Editar()
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            _editForm.Entidad = DirectCast(Me.FOLVRegistros.SelectedObject, Entidades.Categoria)
    ...
    Private Sub Eliminar()
        ...
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            If MessageBox.Show("Desea eliminar el registro seleccionado?", "Eliminar registro", _
                ...
                _repositorio.Delete(DirectCast(FOLVRegistros.SelectedObject, Entidades.Categoria).Id)
    ...
    Private Sub Imprimir()
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\lstCategoriasArt.rdl"
            r.Nombre = "Listado de Categorías de Artículos"
            ...
            r.Parametros.Add(New GeneradorReportes.Parametro("cdesde", DirectCast(FOLVRegistros.SelectedObject, Entidades.Categoria).Codigo))
            r.Parametros.Add(New GeneradorReportes.Parametro("chasta", DirectCast(FOLVRegistros.SelectedObject, Entidades.Categoria).Codigo))
    ...
    Private Sub FormABMCategoria_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
