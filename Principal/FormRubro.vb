Public Class FormRubro
    ...
    Private Sub InicializarFormulario()
        ...
        If Not Entidad Is Nothing Then
            ...
            Me.CtlComboRubroMaestro.SelectedValue = Entidad.Maestro
    ...
    Private Sub FormRubro_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Me.TextBoxCodigo.Focus()
    End Sub
    ...
    Private Sub InicializarComboRubroMaestro()

        Dim repositorio As New CapaLogica.RubromaestroCLog

        With Me.CtlComboRubroMaestro
            .ValueMember = "Id"
            .DisplayMember = "Nombre"
            .DataSource = repositorio.GetAll
            .AutoCompleteMode = AutoCompleteMode.Suggest
            .AutoCompleteSource = AutoCompleteSource.ListItems
            .FormularioDeAlta = FormRubromaestro
            .Inicializar()
            .SelectedIndex = -1
        End With
    End Sub
