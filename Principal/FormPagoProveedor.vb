Public Class FormPagoProveedor
    ...
    Private Sub Reporte()
        ...
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\infpagoproveedor.rdl"
            r.Parametros.Add(New GeneradorReportes.Parametro("titulo", "Resumen de Pago a Proveedores"))
    ...
    Private Sub FormPagoProveedor_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        Me.DateTimePickerDesde.Focus()

        Me.Text = "Resumen de Pago a Proveedores"
    End Sub

    Private Sub FormPagoProveedor_Load(sender As Object, e As System.EventArgs) Handles Me.Load
