Public Class FormArticuloAnterior
    ...
    Private Sub InicializarFormulario()
        ...
        If Not Entidad Is Nothing Then
            ...
            Me.TextBoxPrecioVta.Text = Entidad.Preciodeventa
            Me.TextBoxPrecioVta2.Text = Entidad.Preciodeventa2
            Me.TextBoxPrecioVta3.Text = Entidad.Preciodeventa3
            ...
            Me.TextBoxCoeficienteKilo.Text = Entidad.CoeficienteKG
        ...
        Else 'nuevo registro, valores por defecto
            ...
            Me.CheckBoxModifica.Checked = False
            Me.TextBoxCodigo.Enabled = True
            Me.TextBoxCodigo.Text = _repositorio.GetNextCodigo
            Me.TextBoxCodigoBarra.Text = ""
            Me.TextBoxPrecioVta.Text = 0.0
            Me.TextBoxPrecioVta2.Text = 0.0
            Me.TextBoxPrecioVta3.Text = 0.0
            ...
            Me.TextBoxCoeficienteKilo.Text = 0.0
    ...
    Private Sub FormArticuloAnterior_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'iniciar formulario
    ...
    Public Sub New()
        ...
        AddHandler Me.TextBoxPrecioVta.TextChanged, AddressOf CalculoCambioCosto
        AddHandler Me.TextBoxPrecioVta2.TextChanged, AddressOf CalculoCambioCosto
        AddHandler Me.TextBoxPrecioVta3.TextChanged, AddressOf CalculoCambioCosto
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            Entidad.Impuestointerno = Convert.ToDouble(Me.TextBoxImpuestoInternoImp.Text)
            Entidad.Preciodecosto = Convert.ToDouble(Me.TextBoxPrecioCosto.Text)
            'Entidad.peso
            If Entidad.Preciodeventa = Convert.ToDouble(Me.TextBoxPrecioVta.Text) = False Then
                Entidad.Precioventaanterior = Entidad.Preciodeventa
            End If

            Entidad.Preciodeventa = Convert.ToDouble(Me.TextBoxPrecioVta.Text)

            If Entidad.Preciodeventa2 = Convert.ToDouble(Me.TextBoxPrecioVta2.Text) = False Then
                Entidad.Precioventaanterior2 = Entidad.Preciodeventa2
            End If
            Entidad.Preciodeventa2 = Convert.ToDouble(Me.TextBoxPrecioVta2.Text)

            If Entidad.Preciodeventa3 = Convert.ToDouble(Me.TextBoxPrecioVta3.Text) = False Then
                Entidad.Precioventaanterior3 = Entidad.Preciodeventa3
            End If
            Entidad.Preciodeventa3 = Convert.ToDouble(Me.TextBoxPrecioVta3.Text)
            Entidad.Preciosugerido = Convert.ToDouble(Me.TextBoxPrecioVtaSug.Text)
            Entidad.Preciodecompra = Convert.ToDouble(Me.TextBoxPrecioCompra.Text)
            Entidad.CantidadBulto = Convert.ToDouble(Me.TextBoxCantidadBulto.Text)
            Entidad.Puntominimo = Convert.ToDouble(Me.TextBoxPtoMinimo.Text)
            Entidad.Descuento = Convert.ToDouble(Me.TextBoxDescuento.Text)
            Entidad.Descuento2 = Convert.ToDouble(Me.TextBoxDescuento2.Text)
            Entidad.Descuento3 = Convert.ToDouble(Me.TextBoxDescuento3.Text)
            Entidad.Descuentocompra1 = Convert.ToDouble(Me.TextBoxDtoCompra1.Text)
            Entidad.Descuentocompra2 = Convert.ToDouble(Me.TextBoxDtoCompra2.Text)
            Entidad.Descuentocompra3 = Convert.ToDouble(Me.TextBoxDtoCompra3.Text)
            Entidad.Descuentocompra4 = Convert.ToDouble(Me.TextBoxDtoCompra4.Text)
            Entidad.Rentabilidad1 = Convert.ToDouble(Me.TextBoxRenta1.Text)
            Entidad.Rentabilidad2 = Convert.ToDouble(Me.TextBoxRenta2.Text)
            Entidad.Rentabilidad3 = Convert.ToDouble(Me.TextBoxRenta3.Text)
            'Entidad.Codproveedor = Convert.ToString(Me.ComboBoxProveedor.SelectedValue)
            Entidad.Fechaultimacompra = Me.DTPUltCompra.Value
            Entidad.Oferta = Me.CheckBoxOferta.Checked

            Entidad.CoeficienteKG = Convert.ToDouble(Me.TextBoxCoeficienteKilo.Text)
    ...
    Private Sub MostrarImportes()
        ...
        articulo.Preciodecosto = Val(Me.TextBoxPrecioCosto.Text)
        articulo.Impuestointerno = Val(Me.TextBoxImpuestoInternoImp.Text)
        articulo.Descuento = Val(Me.TextBoxDescuento.Text)
        articulo.Descuento2 = Val(Me.TextBoxDescuento2.Text)
        articulo.Descuento3 = Val(Me.TextBoxDescuento3.Text)
        articulo.Preciodeventa = Val(Me.TextBoxPrecioVta.Text)
        articulo.Preciodeventa2 = Val(Me.TextBoxPrecioVta2.Text)
        articulo.Preciodeventa3 = Val(Me.TextBoxPrecioVta3.Text)

        Me.lblFinalRevendedor.Text = articulo.ImporteFinalLista1.ToString("$ #,##0.000") & " [ Dto. " & articulo.Descuento.ToString("0.00") & "% " & (articulo.ImporteFinalConDescuentoLista1).ToString("$ #,##0.000") & " ]"
        Me.lblFinalKiosko.Text = articulo.ImporteFinalLista2.ToString("$ #,##0.000") & " [ Dto. " & articulo.Descuento2.ToString("0.00") & "% " & (articulo.ImporteFinalConDescuentoLista2).ToString("$ #,##0.000") & "]"
        Me.lblFinalMostrador.Text = articulo.ImporteFinalLista3.ToString("$ #,##0.000") & " [ Dto. " & articulo.Descuento3.ToString("0.00") & "% " & (articulo.ImporteFinalConDescuentoLista3).ToString("$ #,##0.000") & " ]"
    ...
    Private Sub BtnMargenes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnMargenes.Click
