Public Class FormInformeRemitos
    ...
    Private Sub FormInformeRemitos_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        Me.Text = "Consulta de Remitos"
    End Sub
   ...
   Private Sub InicializarComboCliente()
        ...
        With Me.CtlComboClienteDesde
            ...
            .DataSource = _repositorioCli.GetAll.OrderBy(Function(x) x.Codigo).ToList()
    ...
    Private Sub Reporte()
        ...
        Try
            If Me.DateTimePickerDesde.Value > Me.DateTimePickerHasta.Value Then
                Throw New Exception("Entorno de fechas inválido")
            ...
            r.SourceFile = My.Settings.RutaReportes & "\infConsultaRemito.rdl"

            SetearEncabezadosReporte(r)

            r.Parametros.Add(New GeneradorReportes.Parametro("titulo", Me.Text))

            r.Parametros.Add(New GeneradorReportes.Parametro("fdesde", Me.DateTimePickerDesde.Value.ToString("yyyyMMdd")))
            r.Parametros.Add(New GeneradorReportes.Parametro("fhasta", Me.DateTimePickerHasta.Value.ToString("yyyyMMdd")))
    ...
    Private Sub FormInformeRemitos_Load(sender As Object, e As System.EventArgs) Handles Me.Load
