...
Public Class FormABMCuentabancaria
    Private _repositorio As New CapaLogica.CuentabancariaCLog
    Private _editForm As New FormCuentabancaria
    ...
    Private Sub Editar()
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            _editForm.Entidad = DirectCast(Me.FOLVRegistros.SelectedObject, Entidades.Cuentabancaria)
    ...
    Private Sub Eliminar()
        ...
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            If DirectCast(FOLVRegistros.SelectedObject, Entidades.Cuentabancaria).Codigo = CUENTA_CARTERA Or _
                DirectCast(FOLVRegistros.SelectedObject, Entidades.Cuentabancaria).Codigo = repoparametro.GetByNombre("CuentaBancariaAjuste").Valorpredeterminado Or _
                DirectCast(FOLVRegistros.SelectedObject, Entidades.Cuentabancaria).Codigo = repoparametro.GetByNombre("CuentaBancariaAjuste").Valorpredeterminado Then
            ...
            If MessageBox.Show("Desea eliminar el registro seleccionado?", "Eliminar registro", _
                ...
                _repositorio.Delete(DirectCast(FOLVRegistros.SelectedObject, Entidades.Cuentabancaria).Id)
    ...
    Private Sub Imprimir()
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\lstcuentabancaria.rdl"
            r.Nombre = "Listado de Cuentas Financieras"
            ...
            r.Parametros.Add(New GeneradorReportes.Parametro("cdesde", DirectCast(FOLVRegistros.SelectedObject, Entidades.Cuentabancaria).Codigo))
            r.Parametros.Add(New GeneradorReportes.Parametro("chasta", DirectCast(FOLVRegistros.SelectedObject, Entidades.Cuentabancaria).Codigo))
    ...
    Private Sub FormABMCuentabancaria_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
