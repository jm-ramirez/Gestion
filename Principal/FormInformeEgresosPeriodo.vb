Public Class FormInformeEgresosPeriodo
    ...
    Private Sub Reporte()
        ...
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\infEgresoPeriodo.rdl"
    ...
    Private Sub FormInformeEgresosPeriodo_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        Me.Text = "Informe de Egresos por Período"
    End Sub


    Private Sub FormInformeEgresosPeriodo_Load(sender As Object, e As System.EventArgs) Handles Me.Load
