Public Class FormTransportes

    'entidad
    Property Entidad As Entidades.Transporte
    ...
    Private Sub FormTransporte_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'iniciar formulario
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            If Entidad Is Nothing Then
                Entidad = New Entidades.Transporte
            End If
    ...
    Private Sub FormularioKeyDown(ByVal sender As Object, ByVal e As KeyEventArgs)
        Select Case e.KeyCode
            Case Keys.Enter
                If Me.ActiveControl.Name <> "TextBoxDomicilio" And Me.ActiveControl.Name <> "TextBoxObservacion" Then
                    SendKeys.Send("{TAB}")
                End If
