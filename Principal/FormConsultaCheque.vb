...
Public Class FormConsultaCheque
    ...
    Private Sub ContextMenuItemRechazar_Click(sender As Object, e As System.EventArgs) Handles ContextMenuItemRechazar.Click
        Rechazar()
    End Sub
    ...
    Private Sub Rechazar()
        ...
        Try
            If Not FOLVRegistros.SelectedObject Is Nothing Then
                ...
                Dim c As Entidades.Financiero = DirectCast(FOLVRegistros.SelectedObject, Entidades.Financiero)

                If c.EstadoDet <> "RECHAZADO" Then
                    If MessageBox.Show("Confirma rechazar el cheque: " & c.Referencia & "?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then
                        Exit Sub
                    End If
                    ...
                    _repositorio.Rechazar(c.Id, Tipo)
                    ...
                    End If
                Else
                    Throw New Exception("El cheque seleccionado se encuentra rechazado")
                End If
