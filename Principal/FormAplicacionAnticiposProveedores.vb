Public Class FormAplicacionAnticiposProveedores
    ...
    Private _cbteanticipo As Entidades.CpraCabecera

    'inicializo formulario, limpieza o carga de valores
    Private Sub InicializarFormulario()

        Me.Text = "Aplicación de Anticipos a Proveedores"
    ...
    Private Sub InicializarComboCliente()
        With Me.CtlCustomComboProveedor
            ...
            .DataSource = _repositorioProveedores.GetAllOrderByNombre
    ...
    Private Sub CtlCustomComboCliente_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CtlCustomComboProveedor.SelectedIndexChanged
        CargarComprobantes()
    End Sub
    ...
    Private Sub CargaDatosCbte(ByVal id As UInteger)
        ...
        For Each c As Entidades.CpraCabecera In _repositorioCbtes.GetAnticiposProveedor(id, gUsuario.GodMode, False)
    ...
    Private Sub SetearAnticipo()
        ...
        If Not FOLVCompAnticipos.SelectedObject Is Nothing Then
            _cbteanticipo = DirectCast(FOLVCompAnticipos.SelectedObject, Entidades.CpraCabecera)
    ...
    Private Sub InicializarCbteProveedor(ByVal id As UInteger)
        ...
        For Each cbte As Entidades.CpraCabecera In repositorio.GetCprasCtaCteByProveedor(id)
            ...
            Select Case cbte.Cbtetipo
                Case PRESUPUESTO
                    If gUsuario.GodMode Then
                        ...
                        End If
                    End If
                Case FACTURA_A, FACTURA_B, TIQUE_FACTURA_A, TIQUE_FACTURA_B, FACTURA_C, FACTURA_M
                    If cbte.SaldoEstadoCuenta <> 0 Then
                        cbtes.Add(cbte)
                    End If
            End Select
