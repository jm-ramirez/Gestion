...
Public Class CtlDetalleCbteAnterior
    ...
    Public Sub Inicializar()
        ...
        Me.TextBoxImporteFinal.ReadOnly = (Me.TipoDeCbte = TipoCbte.CBTEVTA)
    ...
    Public Sub Limpiar()
        ...
        Me.TextBoxImporteFinal.Text = 0.0
...
Final:
    ...
    Private Sub a_Vista()
        ...
        If TipoCargaCbte = TipoEmisionCbte.PRESUPUESTO Then
            'lblSubtotal.Left = lblDto.Location.X + lblDto.Width + 8
            'TextBoxSubtotalArticulo.Left = TextBoxDto.Location.X + TextBoxDto.Width + 8
            'BtnAgregarArticulo.Left = TextBoxSubtotalArticulo.Location.X + TextBoxSubtotalArticulo.Width + 8
            'lblAlicuota.Visible = False
            'ComboBoxArticuloAlicuota.Visible = False
            ''TextBoxImporteFinal.Visible = True
    ...
    Private Sub ComboBoxArticulos_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBoxArticulos.SelectedIndexChanged
        If ComboBoxArticulos IsNot Nothing Then
            If Me.TipoDeCbte = TipoCbte.CBTECPRA Then
                CargaDatosMaterial()
                'CargaDatosArticulo()
            Else
    ...
    Private Sub TextBoxCantidad_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBoxCantidad.LostFocus
        If Me.TipoDeCbte = TipoCbte.CBTEVTA Or Me.TipoDeCbte = TipoCbte.CBTECPRA Then
            ...
            Me.TextBoxSubtotalArticuloFinal.Text = Format(CDbl(Val(Me.TextBoxCantidad.Text) * Val(Me.TextBoxImporteFinal.Text)), "0.00")
        ...
        If e IsNot Nothing Then
            ...
            If Me.TipoDeCbte = TipoCbte.CBTEVTA Then
                ...
                Else
                    ...
                    Me.TextBoxImporteFinal.ReadOnly = True
                End If
            ...
            If mblnPrecargaRemito = False Or Val(Me.TextBoxImporte.Text) = 0 Then
                ...
                End If
            End If
            Dim Iva As Double = Val(DirectCast(ComboBoxArticuloAlicuota.SelectedItem, Entidades.Tipocondicioniva).Alicuota / 100) + 1
            Me.TextBoxImporteFinal.Text = Format(Val(TextBoxImporte.Text) * Iva, "0.00")
        Else
            ...
            Me.TextBoxImporteFinal.Text = ""
            Me.TextBoxDto.Text = "0"
            Me.TextBoxSubtotalArticulo.Text = "0.00"
            Me.TextBoxSubtotalArticuloFinal.Text = "0.00"
        End If
    ...
    Private Sub TotalizarLinea(Optional TipoPrecio As Integer = 0)
        ...
        If Me.ComboBoxArticuloAlicuota.SelectedItem IsNot Nothing Then
    ...
    Public Sub New()
        ...
        AddHandler Me.TextBoxImporteFinal.KeyPress, AddressOf CustomKeyPressOnlyNumbers
        ...
        AddHandler Me.TextBoxSubtotalArticuloFinal.KeyPress, AddressOf CustomKeyPressOnlyNumbers
        ...
        AddHandler Me.TextBoxImporteFinal.KeyDown, AddressOf CustomKeyDown
        ...
        AddHandler Me.TextBoxSubtotalArticuloFinal.KeyDown, AddressOf CustomKeyDown
        ...
        Select Case e.KeyCode
            Case Keys.Return
                ...
                ElseIf sender Is TextBoxCantidad Then
                    If Me.TipoDeCbte = TipoCbte.CBTEVTA Then
                        'If TextBoxImporteFinal.Visible = True Then
                        '    TextBoxImporteFinal.Focus()
                        'Else
                ...
                ElseIf sender Is ComboBoxArticuloAlicuota Then
                    TextBoxImporteFinal.Focus()
                ElseIf sender Is TextBoxImporteFinal Then
                    TextBoxDto.Focus()
                ElseIf sender Is TextBoxImporte Then 'Or sender Is TextBoxImporteFinal Then
                ...
                ElseIf sender Is TextBoxDto Then
                    ...
                    'Else
                    If Me.TipoDeCbte = TipoCbte.CBTEVTA Then
                        If TextBoxSubtotalArticuloFinal.Visible = True Then
                            TextBoxSubtotalArticuloFinal.Focus()
                        Else
                            TextBoxSubtotalArticulo.Focus()
                        End If
                    Else
                ...
                ElseIf sender Is TextBoxImporteCartera Then
                    Call CrearCheque()
                ElseIf sender Is TextBoxSubtotalArticulo Or sender Is TextBoxSubtotalArticuloFinal Then
                    If Me.TipoDeCbte = TipoCbte.CBTECPRA Then
                        AgregarMaterial()
                    Else
                        AgregarArticulo(0)
