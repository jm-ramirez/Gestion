Public Class FormCuentabancaria

    'entidad
    Property Entidad As Entidades.Cuentabancaria
    ...
    Private Sub FormCuentabancaria_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Me.TextBoxCodigo.Focus()
    End Sub

    Private Sub FormCuentabancaria_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'iniciar formulario
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            If Entidad Is Nothing Then
                Entidad = New Entidades.Cuentabancaria
            End If
