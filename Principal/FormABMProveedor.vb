...
Public Class FormABMProveedor

    Private _repositorio As New CapaLogica.ProveedorCLog
    Private _editForm As New FormProveedor
    ...
    Private Sub Editar()
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            _editForm.Entidad = DirectCast(Me.FOLVRegistros.SelectedObject, Entidades.Proveedor)
    ...
    Private Sub Eliminar()
        ...
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            If DirectCast(FOLVRegistros.SelectedObject, Entidades.Proveedor).Id = repoparametro.GetByNombre("ProveedorGastos").Valorpredeterminado Then
            ...
            If MessageBox.Show("Desea eliminar el registro seleccionado?", "Eliminar registro", _
                ...
                _repositorio.Delete(DirectCast(FOLVRegistros.SelectedObject, Entidades.Proveedor).Id)
    ...
    Private Sub Imprimir()
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\lstProveedores.rdl"
            r.Nombre = "Listado de Proveedores"
            ...
            r.Parametros.Add(New GeneradorReportes.Parametro("cdesde", DirectCast(FOLVRegistros.SelectedObject, Entidades.Proveedor).Codigo))
            r.Parametros.Add(New GeneradorReportes.Parametro("chasta", DirectCast(FOLVRegistros.SelectedObject, Entidades.Proveedor).Codigo))
    ...
    Private Sub FormABMProveedor_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
