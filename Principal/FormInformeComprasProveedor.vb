Public Class FormInformeComprasProveedor
    Private _repositorioProv As New CapaLogica.ProveedorCLog
    ...
    Private Sub InicializarComboProveedor()
        ...
        With Me.CtlComboProveedor
            .ValueMember = "Codigo"
            .DisplayMember = "NombreyCodigo"
            .DataSource = _repositorioProv.GetAll.OrderBy(Function(x) x.Codigo).ToList()
    ...
    Private Sub Reporte()
        ...
        Try
            ...
            If Me.CheckBoxTodos.Checked = False And Me.CtlComboProveedor.SelectedItem Is Nothing Then
                Me.CtlComboProveedor.FocoDetalle()
            ...
            r.SourceFile = My.Settings.RutaReportes & "\infComprasProveedor.rdl"
            ...
            If Me.CheckBoxTodos.Checked = False Then
                ...
                r.Parametros.Add(New GeneradorReportes.Parametro("codProv", DirectCast(Me.CtlComboProveedor.SelectedItem, Entidades.Proveedor).Id))
                r.Parametros.Add(New GeneradorReportes.Parametro("titulo2", "Proveedor: (" & DirectCast(Me.CtlComboProveedor.SelectedItem, Entidades.Proveedor).Codigo & ") " & DirectCast(Me.CtlComboProveedor.SelectedItem, Entidades.Proveedor).Nombre))
            Else
                r.Parametros.Add(New GeneradorReportes.Parametro("filtra", 0))
                r.Parametros.Add(New GeneradorReportes.Parametro("titulo2", "Todos los Proveedores"))
            End If
    ...
    Private Sub FormInformeComprasProveedor_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        Me.Text = "Informe de Compras por Proveedor"
    End Sub
    ...
    Private Sub CheckBoxTodos_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBoxTodos.CheckedChanged
        If Not CheckBoxTodos.Checked Then
            Me.CtlComboProveedor.Enabled = True
            Me.CtlComboProveedor.FocoDetalle()
        Else
            Me.CtlComboProveedor.Enabled = False
        End If
    End Sub

    Private Sub FormInformeComprasProveedor_Load(sender As Object, e As System.EventArgs) Handles Me.Load
