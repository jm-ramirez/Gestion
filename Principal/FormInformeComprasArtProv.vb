Public Class FormInformeComprasArtProv
    ...
    Private Sub Reporte()
        ...
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\infComprasArticuloProveedor.rdl"
    ...
    Private Sub FormInformeComprasArtProv_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        Me.Text = "Informe de Compras por Artículo y Proveedor"
    End Sub

    Private Sub FormInformeComprasArtProv_Load(sender As Object, e As System.EventArgs) Handles Me.Load
