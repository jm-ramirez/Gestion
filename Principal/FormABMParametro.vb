...
Public Class FormABMParametro
    Private _repositorio As New CapaLogica.ParametroCLog
    Private _editForm As New FormParametro
    ...
    Private Sub Editar()
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            _editForm.Entidad = DirectCast(Me.FOLVRegistros.SelectedObject, Entidades.Parametro)
    ...
    Private Sub Eliminar()
        Try
            ...
            Throw New Exception("La eliminación de parametros se encuentra deshabilitada")
            ...
            If Not FOLVRegistros.SelectedObject Is Nothing Then
                ...
                If MessageBox.Show("Desea eliminar el registro seleccionado?", "Eliminar registro", _
                    ...
                    _repositorio.Delete(DirectCast(FOLVRegistros.SelectedObject, Entidades.Parametro).Id)
    ...
    Private Sub Imprimir()
        ...
        r.SourceFile = My.Settings.RutaReportes & "\lstParametro.rdl"
        r.Nombre = "Listado de Parametros"
        r.Parametros.Add(New GeneradorReportes.Parametro("titulo", "Listado de Parametros"))
        r.ShowReport()
    End Sub
    ...
    Private Sub CrearColumnas()
        ...
        With FOLVRegistros
            ...
            c = New BrightIdeasSoftware.OLVColumn
            c.Text = "Valor"
            c.AspectName = "Valorpredeterminado"
            c.MinimumWidth = 150
            c.AutoResize(ColumnHeaderAutoResizeStyle.ColumnContent)
            .Columns.Add(c)
    ...
    Private Sub FormABMParametro_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
