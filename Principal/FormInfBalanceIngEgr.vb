Public Class FormInfBalanceIngEgr
    ...
    Private Sub FormInfBalanceIngEgr_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        InicializarFormulario()
    End Sub
    Private Sub FormEmisionFichaStock_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        Me.Text = "Balance de Ingresos y Egresos"
    End Sub
    ...
    Private Sub Reporte()
        ...
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\infBalanceIngEgr.rdl"
