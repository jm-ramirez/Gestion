Public Class FormConceptobancario

    'entidad
    Property Entidad As Entidades.Conceptobancario
    ...
    Private Sub InicializarFormulario()
        ...
        Me.NumericUpDownPlazo.Minimum = 0
        Me.NumericUpDownPlazo.Maximum = 999
        ...
        If Not Entidad Is Nothing Then
            ...
            Me.NumericUpDownPlazo.Value = Entidad.Plazo

            If Entidad.Tipo = "D" Then
                RadioButtonDeudor.Checked = True
            Else
                RadioButtonAcreedor.Checked = True
            End If
        ...
        Else 'nuevo registro, valores por defecto
            ...
            Me.RadioButtonDeudor.Checked = True
            Me.NumericUpDownPlazo.Value = 0
        End If
    ...
    Private Sub FormConceptobancario_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Me.TextBoxCodigo.Focus()
    End Sub

    Private Sub FormConceptobancario_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'iniciar formulario
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            If Entidad Is Nothing Then
                Entidad = New Entidades.Conceptobancario
            End If

            Entidad.Codigo = Me.TextBoxCodigo.Text.Trim
            ...
            Entidad.Plazo = Me.NumericUpDownPlazo.Value

            If RadioButtonDeudor.Checked = True Then
                Entidad.Tipo = "D"
            Else
                Entidad.Tipo = "C"
            End If
