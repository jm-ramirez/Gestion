    ...
    Private Sub AgregarArticulo(ByVal plngNumero As UInt32, Optional ByVal strDetalleVarios As String = "")
        ...
        Try
            ...
            If TipoCargaCbte = TipoEmisionCbte.PRESUPUESTO Then
                ComboBoxArticuloAlicuota.SelectedValue = Convert.ToUInt32(3)
            End If
            ...
            If Me.TipoDeCbte = TipoCbte.CBTEVTA Then
                If e.Importe = 0 Then
                    ...
                    e.Importe = Convert.ToDouble(Me.TextBoxImporte.Text) - Convert.ToDouble(Me.TextBoxImporteImpInt.Text)
                    e.Importe = Math.Round(e.Importe / (1 + (DirectCast(Me.ComboBoxArticuloAlicuota.SelectedItem, Entidades.Tipocondicioniva).Alicuota / 100)), 3)

                    If e.Importe < 0 Then
                        Throw New Exception("El importe gravado no puede ser un número negativo")
                    End If
...
Final:
    ...
    Private Sub a_Vista()
        ...
        If TipoCargaCbte = TipoEmisionCbte.PRESUPUESTO Then
            ...
            lblDto.Left = lblDto.Location.X + lblAlicuota.Width + 8
            TextBoxDto.Left = lblDto.Location.X ' + lblDto.Width + 8
            lblImporte.Left = lblDto.Location.X - lblImporte.Width - 4
            TextBoxImporte.Left = lblImporte.Location.X
            lblCant.Left = lblImporte.Location.X - lblCant.Width - 4
            TextBoxCantidad.Left = lblCant.Location.X
            ComboBoxArticulos.Width = ComboBoxArticulos.Width + lblAlicuota.Width + 20
        ...
        If e IsNot Nothing Then
            ...
            If Me.ComboBoxArticuloAlicuota.Items.Count > 0 Then
                If TipoCargaCbte = TipoEmisionCbte.PRESUPUESTO Then
                    ComboBoxArticuloAlicuota.SelectedValue = Convert.ToUInt32(3)
                Else
                    ComboBoxArticuloAlicuota.SelectedValue = e.Alicuotaiva
                End If
            Else
                Me.ComboBoxArticuloAlicuota.SelectedIndex = -1
            End If
            ...
            Case Keys.Return
                ...
                ElseIf sender Is TextBoxDto Then
                    ...
                    If Me.TipoDeCbte = TipoCbte.CBTEVTA Then
                        TextBoxSubtotalArticulo.Focus()
                    Else
                        If ComboBoxArticuloAlicuota.Visible Then
    ...
    Private Sub FOLVArticulos_CellEditStarting(ByVal sender As Object, ByVal e As BrightIdeasSoftware.CellEditEventArgs) Handles FOLVArticulos.CellEditStarting
        ...
        If FOLVArticulos.SelectedObject IsNot Nothing Then
            If DirectCast(FOLVArticulos.SelectedObject, Entidades.CbteArticulo).Modificable Or
