...
Public Class FormABMRubromaestro
    Private _repositorio As New CapaLogica.RubromaestroCLog
    Private _editForm As New FormRubromaestro
    ...
    Private Sub Editar()
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            _editForm.Entidad = DirectCast(Me.FOLVRegistros.SelectedObject, Entidades.Rubromaestro)
    ...
    Private Sub Eliminar()
        ...
        If Not FOLVRegistros.SelectedObject Is Nothing Then
            ...
            If MessageBox.Show("Desea eliminar el registro seleccionado?", "Eliminar registro", _
                ...
                _repositorio.Delete(DirectCast(FOLVRegistros.SelectedObject, Entidades.Rubromaestro).Id)
    ...
    Private Sub Imprimir()
        Try
            ...
            r.SourceFile = My.Settings.RutaReportes & "\lstRubrosMaestro.rdl"
            r.Nombre = "Listado de Rubros Maestros"
            ...
            r.Parametros.Add(New GeneradorReportes.Parametro("cdesde", DirectCast(FOLVRegistros.SelectedObject, Entidades.Rubromaestro).Id))
            r.Parametros.Add(New GeneradorReportes.Parametro("chasta", DirectCast(FOLVRegistros.SelectedObject, Entidades.Rubromaestro).Id))
    ...
    Private Sub FormABMRubromaestro_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
